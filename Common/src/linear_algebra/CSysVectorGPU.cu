...
template <class ScalarType>
void CSysVector<ScalarType>::GPUCopy(const CSysVector& src, bool update_host) const {
  (void)src;
  (void)update_host;
...
template <class ScalarType>
void CSysVector<ScalarType>::GPUScale(ScalarType alpha, bool update_host) const {
  (void)alpha;
  (void)update_host;
...
template <class ScalarType>
void CSysVector<ScalarType>::GPUAxpy(ScalarType alpha, const CSysVector& x, bool update_host) const {
  (void)alpha;
  (void)x;
  (void)update_host;
...
template void CSysVector<su2mixedfloat>::GPUCopy(const CSysVector<su2mixedfloat>& src, bool update_host) const;
template void CSysVector<su2mixedfloat>::GPUScale(su2mixedfloat alpha, bool update_host) const;
template void CSysVector<su2mixedfloat>::GPUAxpy(su2mixedfloat alpha, const CSysVector<su2mixedfloat>& x,
                                                 bool update_host) const;
...
template void CSysVector<passivedouble>::GPUCopy(const CSysVector<passivedouble>& src, bool update_host) const;
template void CSysVector<passivedouble>::GPUScale(passivedouble alpha, bool update_host) const;
template void CSysVector<passivedouble>::GPUAxpy(passivedouble alpha, const CSysVector<passivedouble>& x,
                                                 bool update_host) const;
...
template void CSysVector<su2double>::GPUCopy(const CSysVector<su2double>& src, bool update_host) const;
template void CSysVector<su2double>::GPUScale(su2double alpha, bool update_host) const;
template void CSysVector<su2double>::GPUAxpy(su2double alpha, const CSysVector<su2double>& x, bool update_host) const;
