...
class CSysVector : public VecExpr::CVecExpr<CSysVector<ScalarType>, ScalarType> {
 ...
 public:
   ...
   * \param[in] update_host - If true, synchronize the updated device values back to host storage.
   */
  void GPUCopy(const CSysVector& src, bool update_host = false) const;
   ...
   * \param[in] update_host - If true, synchronize the updated device values back to host storage.
   */
  void GPUScale(ScalarType alpha, bool update_host = false) const;
   ...
   * \param[in] update_host - If true, synchronize the updated device values back to host storage.
   */
  void GPUAxpy(ScalarType alpha, const CSysVector& x, bool update_host = false) const;
